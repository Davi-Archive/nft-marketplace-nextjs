    ...
    <>
     ...
     Join 25 million people using ProNef Marketplace."
      ...
      <SectionWrapper
        ...
        natively on all users devices. You can easily get your
        app into people's hands."
        mockupImg={assets.feature}
        reverse
      />

      <SectionWrapper
        title="Creative way yo showcase the store"
      ...
      <footer className="px-4 py-2 justify-center items-center bg-primary flex-col text-center banner04">
        <p className={`${styles.pText} ${styles.whiteText}`}>
          Made with love by <span className="bold">Davi</span>
        </p>
      </footer>
    </>
  );
